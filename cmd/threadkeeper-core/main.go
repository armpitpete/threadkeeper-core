...
func usage(){fmt.Fprintln(os.Stderr,"usage: threadkeeper-core <version|check-json|canonicalize|digest|validate|genesis-check|evidence-check|review-bundle|health-check|source-file-check|portable-check|ledger-inspect|ledger-recovery-proof|recovery-compare|authority-write> ...")}
